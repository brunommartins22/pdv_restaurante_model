...
public class RegraNcmHistorico implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "gen_regra_ncm_historico")
    @SequenceGenerator(name = "gen_regra_ncm_historico", sequenceName = "seq_regra_ncm_historico", allocationSize = 1)
    private Long id;
    @ManyToOne
    private RegraNcm regraNcm;
    ...
    public boolean equals(Object obj) {
        ...
        final RegraNcmHistorico other = (RegraNcmHistorico) obj;
