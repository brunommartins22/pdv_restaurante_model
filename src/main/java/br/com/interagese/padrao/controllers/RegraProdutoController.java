...
import br.com.interagese.padrao.services.RegraProdutoService;
 ...
 */
@RestController
@RequestMapping(path = "/api/regra-produto")
public class RegraProdutoController extends PadraoController<RegraProduto> {

    @IsServiceDefault
    @Autowired
    private RegraProdutoService service;
